...
html_sidebar="""
    <head>
        <h2 style="color:black;">목차</h2>
    </head>
    <body>
        <ul>
            <li class='num1'; style="list-style-type:decimal; color: black; margin-bottom:10px">초기화면</li>
            <li class='num2'; style="list-style-type:decimal; color: black; margin-bottom:10px">타입 고르기</li>
            <li class='num3'; style="list-style-type:decimal; color: black; margin-bottom:10px">입력하기(Base)</li>
            <li class='num4'; style="list-style-type:decimal; color: black; margin-bottom:10px">입력하기(CSV)</li>
            <li class='num5'; style="list-style-type:decimal; color: black; margin-bottom:10px">입력하기(Model)</li>
        </ul>
    </body>
"""
...
html_main = """
        <section id="scroll-num1">
            <div class='num1_container'>
                <h2 style="color:black; margin-top:50px;"> 1. 예측하기 [첫화면]</h2>
                <p class='num1_content'; style='color:black;'> - 동일 건축 프로젝트 홈페이지의 초기 접속 화면입니다.</p>
                ...
                <p class='num1_content'; style='color:black; margin-top:30px;'> - 메뉴얼 페이지와 예측 페이지 중 하나를 선택해주세요. 설명은 예측으로 하겠습니다.</p>
        ...
        <section id="scroll-num2">
            <div id='num2_container'>
                <h2 style="color:black; margin-top:50px;">2. 타입 고르기</h2>
                <p class='num1_content'; style='color:black; margin-top:30px;'> - 예측 종류에는 세가지가 있습니다.</p>
                <p style='color:black; margin-top:20px;'> - <기본(22년 7월)>은 22년 7월까지의 데이터를 기반으로하여 예측을 진행됩니다. </p>
                <p style='color:black; margin-top:20px;'> - <학습데이터 입력 및 예측>은 새로운 데이터를 추가로 학습시킬 때 사용합니다.(추가 모델로 저장됩니다.)  </p>
                <p style='color:black; margin-top:20px;'> -  <최종학습일지정(모델읽어오기)>는 과거 추가 데이터를 입력했던 날짜를 읽어와 그떄의 데이터로 예측을 하는 방법입니다. </p>
        ...
        <section id="scroll-num3">
            <div id='num3_container'>
                <h2 style="color:black;margin-top:50px;">3. 입력하기(Base)</h2>
                <p class='num3_content'; style='color:black;'>Base 타입의 초기 입력창 모습입니다.</p>
                <p class='num3_content'; style='color:black;margin-bottom:10px;'>공고날짜와 낙찰날짜의 경우 클릭하면, 달력이 나오게 됩니다. 해당 달력에서 원하는 날짜를 선택해줍니다.</p>
                <p class='num3_content'; style='color:black;margin-top:20px; margin-bottom:40px;'>다음은 낙찰하한율입니다. 낙찰 하한율도 마찬가지로 클릭하여 원하는 수치를 선택하거나, 키보드로 입력해줍니다.</p>
                ...
                <p class='num3_content'; style='color:black;margin-top:40px;'>다음은 발주청과 시도입니다. 두 항목을 클릭하면, 선택 가능한 발주청과 시도의 목록이 나옵니다. 해당 목록에서 각각 하나씩 선택해줍니다.</p>
                <p class='num3_content'; style='color:black;margin-bottom:40px;'>그 후 마지막으로, 대지면적,연면적,기초금액,세대수 항목에 원하는 수치만큼 작성한 후 좌측 사이트바의 하단에 있는 Show Predict 버튼을 클릭합니다.</p>
                ...
                <p class='num3_content'; style='color:black;'>Show Predict 버튼을 누른후 확인할수있는 첫 화면입니다.</p>
                ...
                <p class='num3_content'; style='color:black;'>결과 확인 창에는 타기업 분석과 유사공고 분석 항목이 있습니다. 먼저 타기업 분석입니다.</p>
                <p class='num3_content'; style='color:black; margin-bottom:40px;'>타기업 분석 항목을 클릭하게 되면, 분석 가능한 기업의 리스트가 있습니다. 그 중 하나를 선택 후 타기업 분석 버튼을 누르게 되면 결과에 해당하는 그래프가 화면에 띄워집니다. </p>
                ...
                <p class='num3_content'; style='color:black; margin-top:30px;'>마지막으로, 유사공고 분석입니다.</p>
                <p class='num3_content'; style='color:black; margin-bottom:40px;'>유사공고 확인하기 버튼을 누르면, 해당 예측값과 비슷한 공고를 확인할 수 있습니다.</p>
        ...
        <section id="scroll-num4">
            <div id='num4_container'>
                <h2 style="color:black; margin-top:50px;">4. 입력하기(CSV)</h2>
                <p class='num4_content'; style='color:black;'>예측 타입에서 CSV를 선택했을 때의 모습입니다.</p>
                <p class='num4_content'; style='color:black;'>먼저 CSV 파일을 업로드 해줍니다. Browse files 버튼을 누르면 파일을 선택할 수 있는 창이 뜨게됩니다. CSV파일을 선택해주세요.</p>
        ...
        <section id="scroll-num5">
            <div id='num5_container'>
                <h2 style="color:black; margin-top:50px;">5. 입력하기(Model) -> 미구현 </h2>
                <p class='num5_content'; style='color:black;'>과거 추가로 데이터(CSV)로 예측했을 경우, 그떄의 기록이 model에 남아있게 됩니다. 그 날짜를 선택하고 예측을하면 따로 데이터 없이 사용이 가능합니다!</p>
            </div>
        </section>
"""
